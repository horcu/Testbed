...
public class AutoFitGridLayout extends ViewGroup {
    ...
    private int indexOfOpponentTile;

    private int indexOfMyTile;
    ...
    public int getIndexOfOpponentTile() {
        return indexOfOpponentTile;
    }

    public void setIndexOfOpponentTile(int indexOfOpponentTile) {
        this.indexOfOpponentTile = indexOfOpponentTile;
    }

    public int getIndexOfMyTile() {
        return indexOfMyTile;
    }

    public void setIndexOfMyTile(int indexOfMyTile) {
        this.indexOfMyTile = indexOfMyTile;
    }
